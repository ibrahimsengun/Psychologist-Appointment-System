...
const faqItems = [
    ...
    },
    {
        ...
        answer:
            'Bilişsel Davranışçı Terapi (BDT), Çözüm Odaklı Terapi, Psikodinamik Terapi, Oyun Terapisi ve Hipnoterapi gibi bilimsel temelli yöntemler danışanın ihtiyacına göre uygulanmaktadır.'
    }
];
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                        <div className="lg:w-1/2 text-center lg:text-left">
                            ...
                            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-6">
                                ...
                                <span className="text-sm font-medium text-primary">Samsun</span>
                            </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                            Çocuklar, ergenler ve yetişkinlerle çalışan Yılmaz; Samsun&apos;da yüz yüze,
                            Türkiye&apos;nin her yerine online psikolojik destek sunmaktadır.
                        </p>
            ...
            <section className="py-16 md:py-24">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <p className="text-sm uppercase tracking-widest text-primary font-medium mb-3">
                            Samsun&apos;da Psikolojik Hizmetler
                        </p>
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Hizmetlerimiz</h2>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Samsun&apos;da bilimsel temelli yaklaşımlarla profesyonel psikolojik destek
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg text-muted-foreground mb-8">
                            Psikolojik sağlığınız için bugün adım atın. Samsun&apos;da yüz yüze veya online
